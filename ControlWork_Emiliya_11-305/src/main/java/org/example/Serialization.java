...
public class Serialization {
    private ArrayList<Programm> programs;
    private String fileName;

    public Serialization(ArrayList<Programm> programs, String fileName) {
        this.programs = programs;
        this.fileName = fileName;
    }

    public static void saveToExcel(ArrayList<Programm> programs, String fileName) throws IOException {
